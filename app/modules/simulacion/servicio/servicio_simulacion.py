...
class ServicioSimulacion:
    ...
    def __init__(self, prompts: PromptsSimulacion) -> None:
        self.prompts = prompts

    async def analizar(self, request: SimulationAnalysisRequest) -> SimulationAnalysisResponse:
    ...
    async def comparar(self, request: SimulationComparisonRequest) -> SimulationComparisonResponse:
...
SimulationsAiService = ServicioSimulacion
