...
class IntencionGuiaAdministrador(str, Enum):
    ...
    EXPLAIN_NOTIFICATIONS = "EXPLAIN_NOTIFICATIONS"
    EXPLAIN_AI_POLICY_CREATION = "EXPLAIN_AI_POLICY_CREATION"
    EXPLAIN_AI_POLICY_EDITION = "EXPLAIN_AI_POLICY_EDITION"
    EXPLICAR_REPOSITORIO_DOCUMENTAL = "EXPLICAR_REPOSITORIO_DOCUMENTAL"
    EXPLICAR_PERMISOS_DOCUMENTALES = "EXPLICAR_PERMISOS_DOCUMENTALES"
    EXPLICAR_AUDITORIA_DOCUMENTAL = "EXPLICAR_AUDITORIA_DOCUMENTAL"
    EXPLICAR_VERSIONES_DOCUMENTO = "EXPLICAR_VERSIONES_DOCUMENTO"
    AYUDA_DOCUMENTO_COLABORATIVO = "AYUDA_DOCUMENTO_COLABORATIVO"
    AYUDA_CARGA_DOCUMENTO = "AYUDA_CARGA_DOCUMENTO"
    AYUDA_CONSULTA_DOCUMENTO = "AYUDA_CONSULTA_DOCUMENTO"
    EXPLICAR_REQUISITOS_INICIALES = "EXPLICAR_REQUISITOS_INICIALES"
    AYUDA_CONFIGURAR_REQUISITOS_INICIALES = "AYUDA_CONFIGURAR_REQUISITOS_INICIALES"
    EXPLICAR_CLASIFICACION_IA = "EXPLICAR_CLASIFICACION_IA"
    EXPLICAR_RECOMENDACION_IA = "EXPLICAR_RECOMENDACION_IA"
    EXPLICAR_TRAZABILIDAD_INTERDEPARTAMENTAL = "EXPLICAR_TRAZABILIDAD_INTERDEPARTAMENTAL"
    EXPLICAR_TAREAS_COMPARTIDAS = "EXPLICAR_TAREAS_COMPARTIDAS"
    EXPLICAR_PREDICCION_RUTA = "EXPLICAR_PREDICCION_RUTA"
    EXPLICAR_CUELLO_BOTELLA = "EXPLICAR_CUELLO_BOTELLA"
    EXPLICAR_ANOMALIAS = "EXPLICAR_ANOMALIAS"
    EXPLICAR_PRIORIDAD_INTELIGENTE = "EXPLICAR_PRIORIDAD_INTELIGENTE"
    EXPLICAR_REPORTES_DINAMICOS = "EXPLICAR_REPORTES_DINAMICOS"
    GUIDE_CREATE_DYNAMIC_REPORT = "GUIDE_CREATE_DYNAMIC_REPORT"
    EXPLAIN_EXPORT_FORMATS = "EXPLAIN_EXPORT_FORMATS"
    AYUDA_REPORTES_DINAMICOS = "AYUDA_REPORTES_DINAMICOS"
...
class IntencionGuiaFuncionario(str, Enum):
    ...
    AYUDA_CARGA_DOCUMENTO = "AYUDA_CARGA_DOCUMENTO"
    AYUDA_CONSULTA_DOCUMENTO = "AYUDA_CONSULTA_DOCUMENTO"
    EXPLICAR_REQUISITOS_INICIALES_USUARIO = "EXPLICAR_REQUISITOS_INICIALES_USUARIO"
    EXPLICAR_TRAZABILIDAD_INTERDEPARTAMENTAL = "EXPLICAR_TRAZABILIDAD_INTERDEPARTAMENTAL"
    EXPLICAR_TAREAS_COMPARTIDAS = "EXPLICAR_TAREAS_COMPARTIDAS"
    EXPLICAR_SOLICITUD_ORIGINAL_USUARIO = "EXPLICAR_SOLICITUD_ORIGINAL_USUARIO"
    EXPLICAR_POLITICA_RECOMENDADA_IA = "EXPLICAR_POLITICA_RECOMENDADA_IA"
    EXPLICAR_PREDICCION_RUTA = "EXPLICAR_PREDICCION_RUTA"
    EXPLICAR_CUELLO_BOTELLA = "EXPLICAR_CUELLO_BOTELLA"
    EXPLICAR_ANOMALIAS = "EXPLICAR_ANOMALIAS"
    EXPLICAR_PRIORIDAD_INTELIGENTE = "EXPLICAR_PRIORIDAD_INTELIGENTE"
    EXPLICAR_ACCESO_REPORTES = "EXPLICAR_ACCESO_REPORTES"
...
class IntencionGuiaUsuarioMovil(str, Enum):
    ...
    EXPLICAR_REQUISITOS_INICIALES = "EXPLICAR_REQUISITOS_INICIALES"
    AYUDA_LLENAR_REQUISITOS_INICIALES = "AYUDA_LLENAR_REQUISITOS_INICIALES"
    EXPLICAR_CLASIFICACION_IA = "EXPLICAR_CLASIFICACION_IA"
    EXPLICAR_RECOMENDACION_IA = "EXPLICAR_RECOMENDACION_IA"
    EXPLICAR_PREDICCION_RUTA = "EXPLICAR_PREDICCION_RUTA"
    EXPLICAR_CUELLO_BOTELLA = "EXPLICAR_CUELLO_BOTELLA"
