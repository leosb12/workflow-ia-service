...
from app.modules.user_guide.common.guide_request import EmployeeGuideRequest
...
class EmployeeGuideService:
    ...
    async def guide_employee(self, request: EmployeeGuideRequest) -> EmployeeGuideResponse:
